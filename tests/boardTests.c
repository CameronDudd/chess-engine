...
TEST(boardTests, testInitBitBoards) {
  ...
  TEST_ASSERT_EQUAL_UINT64(0x0000000000000042, pieceBitBoards[BLACK_KNIGHT_KEY]);
  TEST_ASSERT_EQUAL_UINT64(0x0000000000000024, pieceBitBoards[BLACK_BISHOP_KEY]);
  ...
  TEST_ASSERT_EQUAL_UINT64(0x4200000000000000, pieceBitBoards[WHITE_KNIGHT_KEY]);
  TEST_ASSERT_EQUAL_UINT64(0x2400000000000000, pieceBitBoards[WHITE_BISHOP_KEY]);
